...
<script type="text/javascript" language="JavaScript" src="skins/{VAL_SKIN}/php/compress.php?get=../javascript/tooltip.js"></script>
<!--[if lte IE 6]>
...
<div id="pageSurround">
	<div id="subSurround">
      ...
      <div id="shoppingCart">
      	...
      	<span id="ajaxCart" style="display:block;"><a class="ajaxCart" style="display: block; color:#FFF;" href="index.php?_g=co&amp;_a=cart">0</a></span>
        <a href="index.php?_g=co&amp;_a=cart" title="Shopping Cart">
